...
const featuredExamData: Record<string, ExamInfo> = {
  ...
  "三重大学": { year:"2026年度", front:true, latter:true, common:"650点", second:"700点", subjects:"数学・理科2・外国語・面接", latterCommon:"650点", latterSecond:"300点", latterSubjects:"小論文・面接", recommendation:"学校推薦型選抜あり", general:"前期・後期", source:"https://www.mie-u.ac.jp/exam/faculty/guidelines/" },
  ...
  "筑波大学": { year:"2026年度", front:true, latter:false, common:"950点", second:"1,400点", subjects:"数学・理科2・外国語・適性試験・面接", recommendation:"学校推薦型・総合型選抜あり", general:"前期のみ", source:"https://ac.tsukuba.ac.jp/apply/application-guidelines/" },
  "神戸大学": { year:"2026年度", front:true, latter:false, common:"380点", second:"480点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型・総合型選抜あり", general:"前期のみ", source:"https://www.office.kobe-u.ac.jp/stdnt-examinavi/juken/" },
  ...
  "広島大学": { year:"2026年度", front:true, latter:false, common:"1,000点", second:"2,000点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型・総合型選抜あり", general:"前期のみ", source:"https://www.hiroshima-u.ac.jp/nyushi" },
...
const additionalExamData: Record<string, ExamInfo> = {
  ...
  "弘前大学": pendingExam("https://nyushi.hirosaki-u.ac.jp/faculty/"),
  "秋田大学": pendingExam("https://www.akita-u.ac.jp/honbu/exam/", "学校推薦型選抜Ⅱあり", true),
  "山形大学": { year:"2026年度", front:true, latter:false, common:"950点", second:"700点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜Ⅱ・地域枠あり", general:"前期のみ", source:"https://www.yamagata-u.ac.jp/jp/entrance/" },
  "福島県立医科大学": { year:"2026年度", front:true, latter:false, common:"700点", second:"600点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.fmu.ac.jp/admission/medicine/exam.html" },
  "群馬大学": { year:"2026年度", front:true, latter:false, common:"475点", second:"450点", subjects:"数学・理科2・小論文・面接", recommendation:"学校推薦型選抜あり", general:"前期のみ", source:"https://www.gunma-u.ac.jp/admission/" },
  "横浜市立大学": pendingExam("https://www.yokohama-cu.ac.jp/admissions/"),
  "新潟大学": { year:"2026年度", front:true, latter:false, common:"800点", second:"1,200点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜あり", general:"前期のみ", source:"https://www.niigata-u.ac.jp/news/2025/991080/" },
  ...
  "滋賀医科大学": { year:"2026年度", front:true, latter:false, common:"650点", second:"600点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜あり", general:"前期のみ", source:"https://www.shiga-med.ac.jp/admission/undergraduate/schedule-of-examinations" },
  "京都府立医科大学": pendingExam("https://www.kpu-m.ac.jp/doc/examination/"),
  "大阪公立大学": { year:"2026年度", front:true, latter:false, common:"675点", second:"900点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.omu.ac.jp/admissions/ug/exam_info/summary/" },
  "奈良県立医科大学": pendingExam("https://www.naramed-u.ac.jp/university/nyushijoho/", "学校推薦型選抜・地域枠あり", true),
  "和歌山県立医科大学": { year:"2026年度", front:true, latter:false, common:"600点", second:"700点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.wakayama-med.ac.jp/nyushi/" },
  "鳥取大学": pendingExam("https://www.tottori-u.ac.jp/admission/"),
  "島根大学": { year:"2026年度", front:true, latter:false, common:"930点", second:"720点", subjects:"数学・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www2.med.shimane-u.ac.jp/medicine/nyushi/" },
  "山口大学": pendingExam("https://www.yamaguchi-u.ac.jp/nyushi/", "学校推薦型選抜Ⅱ・地域枠あり", true),
  "徳島大学": { year:"2026年度", front:true, latter:false, common:"900点", second:"400点", subjects:"数学・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.tokushima-u.ac.jp/admission/docs/69867.html" },
  "香川大学": { year:"2026年度", front:true, latter:false, common:"700点", second:"700点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.kagawa-u.ac.jp/admission/" },
  "愛媛大学": { year:"2026年度", front:true, latter:false, common:"500点", second:"700点", subjects:"数学・理科2・総合問題・面接", recommendation:"学校推薦型選抜Ⅱあり", general:"前期のみ", source:"https://www.ehime-u.ac.jp/tp_20250619_adm/" },
  "高知大学": pendingExam("https://nyusi.kochi-u.jp/"),
  "九州大学": pendingExam("https://www.kyushu-u.ac.jp/ja/admission/", "総合型選抜あり"),
  "佐賀大学": { year:"2026年度", front:true, latter:false, common:"640点", second:"300点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜・地域枠あり", general:"前期のみ", source:"https://www.sao.saga-u.ac.jp/" },
  "長崎大学": pendingExam("https://www.nagasaki-u.ac.jp/nyugaku/"),
  "熊本大学": { year:"2026年度", front:true, latter:false, common:"500点", second:"800点", subjects:"数学・理科2・外国語・面接", recommendation:"学校推薦型選抜Ⅱあり", general:"前期のみ", source:"https://www.kumamoto-u.ac.jp/nyuushi/" },
  ...
  "鹿児島大学": { year:"2026年度", front:true, latter:true, common:"925点", second:"920点", subjects:"数学・理科2・外国語・面接", latterCommon:"925点", latterSecond:"320点", latterSubjects:"小論文・面接", recommendation:"学校推薦型選抜Ⅱあり", general:"前期・後期", source:"https://www.kagoshima-u.ac.jp/exam/" },
  "琉球大学": { year:"2026年度", front:true, latter:true, common:"1,100点", second:"300点", subjects:"数学・理科2・外国語・面接", latterCommon:"1,100点", latterSecond:"300点", latterSubjects:"小論文・面接", recommendation:"学校推薦型選抜Ⅱ・地域枠あり", general:"前期・後期", source:"https://www.u-ryukyu.ac.jp/admissions/" },
};
